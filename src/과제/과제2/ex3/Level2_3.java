...
public class Level2_3 {
	...
	public static void main(String[] args) {
		...
		int sum=kor+eng+mat;
		float avg=sum/3;
		boolean mul3=sum%3==0?true:false;
		boolean mul8=sum%8==0?true:false;
		String odd=sum%2==1?"홀수":"짝수";
		String result=sum>=65?"합격":"탈락";
		System.out.printf("%d\t%d\t%d\t%d\t%.1f\t%s\t%s\t%s\t%s",kor,eng,mat,sum,avg,mul3,mul8,odd,result);
		/* ----------- */
	}
}
/* 
