...
public class Calculator {
    ...
    int plus(int x, int y){
        ...
        //3. (iont x, int y) : 메소드를 호출할때 전달한 매개값을 x와 y를 받았다는 뜻
        //5. void 제외한 함수 내 return 무조건 1개이상 필수
        int result=x+y;
        return result;
    }
    ...
    double divide(int x, int y){
        ...
        return result;
        //return : 함수를 종료하는 키워드 vs break : 가장 가까운 반복문 종료할때 사용
    }
}
