...
public class Step3 {
    public static void main(String[] args) {
        ...
        Car myCar=new Car();
            //myCar.tire=null;
            //myCar.tire(); //참조값이 없다(null) -> (.)도트연산자 사용불가
        //객체
        Car yourCar=new Car();
